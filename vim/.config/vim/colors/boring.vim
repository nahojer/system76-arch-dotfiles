...
if &background ==# 'dark'
  ...
  " TODO
  hi Comment guifg=#080808 guibg=NONE gui=bold cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi Comment ctermfg=232 ctermbg=NONE cterm=NONE
...
" Color: light6        #870087           90                darkmagenta
...
" Color: diffgreen     #2ECC71           114               green
